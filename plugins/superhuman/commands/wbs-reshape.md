...
- **Project workflow has no terminal `archived` status** — hard error from the skill's step 1. Reshape archive semantics require it. (The `superhuman-wbs` pack declares it.)
